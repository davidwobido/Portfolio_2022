    ...
    <div className={styles.wrapper}>
      ...
      <main>
        ...
        <section className={styles.impressum}>
          ...
          <h3 className={styles["impressum-h3"]}>
          ...
          <h3 className={styles["impressum-h3"]}>Kontakt</h3>
          <p>
            Telefon: 01722181200
            <br />
            E-Mail: me@davidwobido.de
          </p>
        ...
        <section className={styles.DSGVO}>
          <h2 className={styles["impressum-h2"]}>Datenschutzerklärung</h2>
          <h3 className={styles["impressum-h3"]}>Einleitung</h3>
          <p>
          ...
          <p>Stand: 4. Februar 2022</p>
          <h3 className={styles["impressum-h3"]}>Verantwortlicher</h3>
          <p>
            David Wobido
            <br />
            Sonnenallee 170
          ...
          E-Mail-Adresse:
          <p>
            <a href="mailto:me@davidwobido.de">me@davidwobido.de</a>
          </p>
          Impressum:
          <p>www.davidwobido.de/impressum</p>
          <h3 className={styles["impressum-h3"]}>
          ...
          <h4 className={styles["impressum-h4"]}>
          ...
          <h4 className={styles["impressum-h4"]}>Zwecke der Verarbeitung</h4>
          <ul>
          ...
          <h3 className={styles["impressum-h3"]}>Sicherheitsmaßnahmen</h3>
          <p>
          ...
          <h3 className={styles["impressum-h3"]}>Löschung von Daten</h3>
          <p>
          ...
          <h3 className={styles["impressum-h3"]}>Einsatz von Cookies</h3>
          <p>
          ...
          <ul>
            <li>
              ...
              Company, Wilton Place, Dublin 2, Irland; <strong>Website:</strong>
              <a href="https://www.linkedin.com">
                https://www.linkedin.com
              </a>; <strong>Datenschutzerklärung:</strong>
            ...
            <li>
              ...
              <strong>Dienstanbieter:</strong> XING AG, Dammtorstraße 29-32,
              20354 Hamburg, Deutschland; <strong>Website:</strong>
              <a href="https://www.xing.de">https://www.xing.de</a>;
              <strong>Datenschutzerklärung:</strong>
          ...
          <h3 className={styles["impressum-h3"]}>Begriffsdefinitionen</h3>
          <p>
